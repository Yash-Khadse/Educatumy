        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-primary">Educatumy</span>
            </motion.h1>
            ...
            >
              Providing exceptional educational services tailored to your needs.
              From major projects to one-on-one tutoring, we're here to help you
              succeed.
            </motion.p>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="subtitle mx-auto">
              We offer a wide range of educational services designed to help you
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Comprehensive educational projects for advanced learning,
                including full-stack web applications and complex software
                development.
              </p>
              <Link
                to="/services"
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Focused educational exercises designed to teach specific
                concepts or technologies in a shorter timeframe.
              </p>
              <Link
                to="/services"
                className="inline-flex items-center text-primary hover:text-primary/80"
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                One-on-one and group tutoring sessions with experienced
                educators to help you master difficult concepts.
              </p>
              <Link
                to="/services"
                className="inline-flex items-center text-primary hover:text-primary/80"
